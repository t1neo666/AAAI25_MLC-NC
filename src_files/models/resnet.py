...
from timm.models.resnet import make_blocks, Bottleneck
...
class ResNet(nn.Module):
    def __init__(
        ...
        # self.global_pool = create_classifier(self.num_features, self.num_classes, pool_type=global_pool)
        # self.fc = nn.Sequential(OrderedDict([('fc', self.fc)]))
...
def resnet50(model_params):
    ...
    layers_list = [3, 4, 6, 3]
    model = ResNet(layers=layers_list, num_classes=num_classes, in_chans=in_chans, block=Bottleneck)
    return model